...
def edit_student(student_id, subject):
    ...
    if form.validate_on_submit():
        ...
        # Update quizzes
        student.midterm_quiz1 = clean_input(form.midterm_quiz1)
        student.midterm_quiz2 = clean_input(form.midterm_quiz2)
        student.midterm_quiz3 = clean_input(form.midterm_quiz3)
        student.midterm_quiz4 = clean_input(form.midterm_quiz4)
        student.midterm_e_quiz1 = clean_input(form.midterm_e_quiz1)
        student.midterm_e_quiz2 = clean_input(form.midterm_e_quiz2)
        student.midterm_e_quiz3 = clean_input(form.midterm_e_quiz3)
        student.midterm_e_quiz4 = clean_input(form.midterm_e_quiz4)
        student.midterm_l_quiz1 = clean_input(form.midterm_l_quiz1)
        student.midterm_l_quiz2 = clean_input(form.midterm_l_quiz2)
        student.midterm_l_quiz3 = clean_input(form.midterm_l_quiz3)
        student.midterm_l_quiz4 = clean_input(form.midterm_l_quiz4)

        student.final_quiz1 = clean_input(form.final_quiz1)
        student.final_quiz2 = clean_input(form.final_quiz2)
        student.final_quiz3 = clean_input(form.final_quiz3)
        student.final_quiz4 = clean_input(form.final_quiz4)
        student.final_e_quiz1 = clean_input(form.final_e_quiz1)
        student.final_e_quiz2 = clean_input(form.final_e_quiz2)
        student.final_e_quiz3 = clean_input(form.final_e_quiz3)
        student.final_e_quiz4 = clean_input(form.final_e_quiz4)
        student.final_l_quiz1 = clean_input(form.final_l_quiz1)
        student.final_l_quiz2 = clean_input(form.final_l_quiz2)
        student.final_l_quiz3 = clean_input(form.final_l_quiz3)
        student.final_l_quiz4 = clean_input(form.final_l_quiz4)

        # Update PIT
        student.midterm_pit1 = clean_input(form.midterm_pit1)
        student.midterm_pit2 = clean_input(form.midterm_pit2)
        student.midterm_pit3 = clean_input(form.midterm_pit3)
        student.midterm_pit4 = clean_input(form.midterm_pit4)
        student.final_pit1 = clean_input(form.final_pit1)
        student.final_pit2 = clean_input(form.final_pit2)
        student.final_pit3 = clean_input(form.final_pit3)
        student.final_pit4 = clean_input(form.final_pit4)

        # Update Exercises
        student.midterm_exercise1 = clean_input(form.midterm_exercise1)
        student.midterm_exercise2 = clean_input(form.midterm_exercise2)
        student.midterm_exercise3 = clean_input(form.midterm_exercise3)
        student.midterm_exercise4 = clean_input(form.midterm_exercise4)
        student.final_exercise1 = clean_input(form.final_exercise1)
        student.final_exercise2 = clean_input(form.final_exercise2)
        student.final_exercise3 = clean_input(form.final_exercise3)
        student.final_exercise4 = clean_input(form.final_exercise4)

        # Update Laboratories
        student.midterm_laboratory1 = clean_input(form.midterm_laboratory1)
        student.midterm_laboratory2 = clean_input(form.midterm_laboratory2)
        student.midterm_laboratory3 = clean_input(form.midterm_laboratory3)
        student.midterm_laboratory4 = clean_input(form.midterm_laboratory4)
        student.final_laboratory1 = clean_input(form.final_laboratory1)
        student.final_laboratory2 = clean_input(form.final_laboratory2)
        student.final_laboratory3 = clean_input(form.final_laboratory3)
        student.final_laboratory4 = clean_input(form.final_laboratory4)

        # Update exams and grades (all strings)
        student.midterm_exam = clean_input(form.midterm_exam)
        student.final_exam = clean_input(form.final_exam)
        student.midterm_grade = clean_input(form.midterm_grade)
        student.final_grade = clean_input(form.final_grade)
        student.midterm_remarks = clean_input(form.midterm_remarks)
        student.final_remarks = clean_input(form.final_remarks)
